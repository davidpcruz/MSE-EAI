...
public class UserBeanW {
	...
	public String getSubscriptionChangeAction(Company company) {
		// return ((company.getSubscribedUsers().size() == 0) ?
		// UserBeanW.SUBSCRIBE_ACTION_NAME : UserBeanW.UNSUBSCRIBE_ACTION_NAME);

		// TODO: This is tmp for debug. Replace by a method that checks the
		// subscription
		return ((company.getName().startsWith("B")) ? UserBeanW.SUBSCRIBE_ACTION_NAME
